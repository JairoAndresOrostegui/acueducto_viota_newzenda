part of 'invoice_printing_service.dart';
...
class _ReceiptPage extends pw.StatelessWidget {
  ...
  pw.TextStyle get _valueStyle =>
      pw.TextStyle(font: regularFont, fontSize: 9.8);
  ...
  pw.Widget _detailAndSummarySection() {
    final serviceCharge = invoice.lineas.fold<int>(0, (sum, item) {
      ...
      return description.contains('cargo fijo') ? sum + item.valorTotal : sum;
    });
              ...
              pw.Padding(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(
                      InvoicePrintingService.detachablePeriodLabel(
                        invoice.periodo,
                      ),
